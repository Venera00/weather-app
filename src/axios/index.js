...
//   const url = newURL(BASE_URL+infoType)
...
//   return {lat, lon, temp, feels_like, temp_min, temp_max, humidity, pressure, name, dt,country, sunrise, sunset, details, icon, speed}
// }
...
// const getFormattedData = (searchParams)=> {
